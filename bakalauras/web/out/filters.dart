...
void init_autogenerated() {
  ...
  __t.bindClass(__e6, () => selected[0], false);
  __e7 = __root.nodes[3].nodes[3];
  __t.bindClass(__e7, () => selected[1], false);
  __e8 = __root.nodes[3].nodes[5];
  __t.bindClass(__e8, () => selected[2], false);
  __e9 = __root.nodes[3].nodes[7];
  __t.bindClass(__e9, () => selected[3], false);
  __e10 = __root.nodes[3].nodes[9];
  __t.bindClass(__e10, () => selected[4], false);
  __e11 = __root.nodes[3].nodes[11];
  __t.bindClass(__e11, () => selected[5], false);
  __t.create();
  __t.insert();
}
